...
`,nt=t=>t instanceof MouseEvent?{x:t.clientX,y:t.clientY}:t.touches&&t.touches.length>0?{x:t.touches[0].clientX,y:t.touches[0].clientY}:{x:0,y:0},k=/^(\d+(?:\.\d+)?)%$/u,_e=/^(\d+(?:\.\d+)?)px$/u,Me=/^(\d+(?:\.\d+)?)vw$/u,Pe=/^(\d+(?:\.\d+)?)vh$/u,U=t=>{const e=t.match(Me);if(e)return Number(e[1])/100*window.innerWidth;const s=t.match(Pe);if(s)return Number(s[1])/100*window.innerHeight;const n=t.match(_e);if(n)return Number(n[1])},te=t=>{if(typeof t=="number")return t;const e=t.match(k);return e?Number(e[1])/100:void 0},rt=t=>typeof t=="number"?t:U(t),ot=(t,e=!1)=>{if(Array.isArray(t))return{ratio:te(t[0]),absolute:rt(t[1])};if(typeof t=="number")return e?{ratio:t}:{absolute:t};const s=te(t);return s!==void 0?{ratio:s}:{absolute:U(t)}},it=(t,e,s)=>{const{ratio:n,absolute:r}=t,o=n!==void 0?n*e:void 0;return o!==void 0&&r!==void 0?s?Math.max(o,r):Math.min(o,r):o??r},D=(t,e,s,n=!1)=>{if(t===void 0)return;const r=ot(t,n);return it(r,e,s)},at=(t,e)=>typeof t=="string"?_e.test(t)||Me.test(t)||Pe.test(t):typeof t=="number"&&(e?t>1:!0),ct=t=>typeof t=="number"&&t>=0&&t<=1||typeof t=="string"&&k.test(t),lt=(t,e=!1)=>{if(!Array.isArray(t))return!1;const[s,n]=t;return Array.isArray(s)||Array.isArray(n)?!0:!(ct(s)&&at(n,e))},se=(t,e,s,n=!1)=>{if(t===void 0)return[void 0,void 0];if(lt(t,n)){const[r,o]=t;return[D(r,e,s,n),D(o,e,s,n)]}return[D(t,e,s,n),void 0]},ne=(t,e,s)=>{const[n,r]=se(t,s,!0),[o,l]=se(e,s,!1);return{prevMin:n,prevMax:o,nextMin:r,nextMax:l}},F=(t,e,s,n)=>{const r=n>0?s/n:0,o=1-r;return t.style.flexBasis=`${r*100}%`,e.style.flexBasis=`${o*100}%`,{ratios:[r,o]}},ut=t=>{var s;if(Array.isArray(t)){const n=t[0];return typeof n=="number"?n:Number(((s=n.match(k))==null?void 0:s[1])??50)/100}if(typeof t=="number")return t;const e=t.match(k);return e?Number(e[1])/100:.5},dt=t=>typeof t=="number"?t:U(t)??0,ht=(t,e,s)=>{var a;const n=t[0];let r;if(Array.isArray(n)){const[i,d]=n,v=typeof i=="number"?i:Number(((a=i.match(k))==null?void 0:a[1])??50)/100;r=Math.min(v*s,dt(d))}else r=ut(n)*s;let o=0,l=s;return e.prevMin!==void 0&&(o=Math.max(o,e.prevMin)),e.prevMax!==void 0&&(l=Math.min(l,e.prevMax)),e.nextMax!==void 0&&(o=Math.max(o,s-e.nextMax)),e.nextMin!==void 0&&(l=Math.min(l,s-e.nextMin)),l<o?e.prevMax??l:Math.max(o,Math.min(r,l))},ft=(t,e)=>{let s=t;return e.prevMin!==void 0&&(s=Math.max(s,e.prevMin)),e.prevMax!==void 0&&(s=Math.min(s,e.prevMax)),Math.max(0,s)},pt=(t="horizontal")=>{const e=Ee();return R(()=>{e.setAttribute("data-direction",t)},[t]),R(()=>{const s=(i,d)=>{const v=nt(d);e.dispatchEvent(new CustomEvent("resize",{detail:{phase:i,mousePosition:v},bubbles:!0}))},n=i=>s("move",i),r=i=>{e.removeAttribute("data-dragging"),s("end",i),document.removeEventListener("mousemove",n),document.removeEventListener("mouseup",r),document.removeEventListener("touchmove",n),document.removeEventListener("touchend",r)},o=i=>{e.setAttribute("data-dragging","true"),s("start",i),document.addEventListener("mousemove",n),document.addEventListener("mouseup",r),document.addEventListener("touchmove",n,{passive:!1}),document.addEventListener("touchend",r)},l=i=>{i.preventDefault(),o(i)},a=i=>{i.preventDefault(),o(i)};return e.addEventListener("mousedown",l),e.addEventListener("touchstart",a,{passive:!1}),()=>{e.removeEventListener("mousedown",l),e.removeEventListener("touchstart",a),document.removeEventListener("mousemove",n),document.removeEventListener("mouseup",r),document.removeEventListener("touchmove",n),document.removeEventListener("touchend",r)}},[e]),null},mt=we`
	:host {
		display: block;
...
`,vt=({direction:t="horizontal"})=>(pt(t),Ne);customElements.define("cosmoz-resize-handle",Se(vt,{styleSheets:[mt],observedAttributes:["direction"]}));const bt=(t,e,s)=>s==="horizontal"?t.x-e.left:t.y-e.top,Re=(t,e)=>e==="horizontal"?t.width:t.height,yt=(t,e,s)=>{let n=t;return e!==void 0&&(n=Math.max(n,e)),s!==void 0&&(n=Math.min(n,s)),Math.max(0,n)},wt=(t,e)=>{const s=e>0?e:1,n=t/s;return[n,1-n]},gt=(t,e,s)=>(t.rect||(t.rect=e.container.getBoundingClientRect(),t.size=Re(t.rect,s)),t.rect),xt=t=>{const e={rect:void 0,size:0},s=(n,r,o)=>{var d,v;const l=gt(e,o.elements,o.direction),a=yt(bt(r,l,o.direction),o.minSize,o.maxSize),i=wt(a,e.size);n==="move"?(d=o.onResize)==null||d.call(o,{ratios:i,px:a}):((v=o.onResizeEnd)==null||v.call(o,{ratios:i}),e.rect=void 0)};return n=>{var l;const{phase:r,mousePosition:o}=n.detail;if(r==="start"){e.rect=t.elements.container.getBoundingClientRect(),e.size=Re(e.rect,t.direction),(l=t.onResizeStart)==null||l.call(t);return}(r==="move"||r==="end")&&s(r,o,t)}},H=(t,e)=>t.dispatchEvent(new CustomEvent("split-resize",{detail:{ratios:e},bubbles:!0})),L=(t,e)=>{const s=t.getBoundingClientRect();return e==="horizontal"?s.width:s.height},zt=({direction:t="horizontal",initialSizes:e=[.5,.5],minSize:s,maxSize:n,persist:r})=>{const o=Ee(),l=ze(.5),a=Q(()=>{if(typeof r=="string")return et();if(r&&typeof r=="object")return r},[r]),i=Q(()=>{if(typeof r=="string")return r;if(r&&typeof r=="object")return"default"},[r]),d=tt(a,i,f=>{var u,b;l.current=f;const y=o.shadowRoot;if(!y)return;const w=(u=y.querySelector('slot[name="previous"]'))==null?void 0:u.assignedElements()[0],g=(b=y.querySelector('slot[name="next"]'))==null?void 0:b.assignedElements()[0];if(!w||!g)return;const m=L(o,t),{ratios:p}=F(w,g,f*m,m);H(o,p)}),v=()=>{var W;const f=o.shadowRoot;if(!f)return;const y=f.querySelector('slot[name="previous"]'),w=f.querySelector('slot[name="next"]'),g=f.querySelector("slot:not([name])");if(!y||!w||!g)return;let m=y.assignedElements()[0],p=w.assignedElements()[0];const u=g.assignedElements().filter(Ce=>!Ce.hasAttribute("slot"));!m&&u.length>0&&(m=u.shift(),m.setAttribute("slot","previous")),!p&&u.length>0&&(p=u.shift(),p.setAttribute("slot","next"));const b=f.querySelector("cosmoz-resize-handle");if(!m||!p||!b)return;const h=L(o,t),_=ne(s,n,h),C=(W=a==null?void 0:a.get)==null?void 0:W.call(a,i??""),ke=C!==void 0?ft(C*h,_):ht(e,_,h),{ratios:X}=F(m,p,ke,h);l.current=X[0],H(o,X)};return R(()=>{o.setAttribute("data-direction",t);const f=o.shadowRoot,y=f==null?void 0:f.querySelector("cosmoz-resize-handle");y&&y.setAttribute("data-direction",t)},[t]),R(()=>{var u,b;const f=o.shadowRoot;if(!f)return;const y=(u=f.querySelector('slot[name="previous"]'))==null?void 0:u.assignedElements()[0],w=(b=f.querySelector('slot[name="next"]'))==null?void 0:b.assignedElements()[0],g=f.querySelector("cosmoz-resize-handle");if(!y||!w||!g)return;const m=ne(s,n,L(o,t)),p=xt({elements:{previous:y,next:w,container:o},direction:t,minSize:m.prevMin,maxSize:m.prevMax,onResize:({ratios:h,px:_})=>{const C=L(o,t);F(y,w,_,C),l.current=h[0],H(o,h)},onResizeEnd:({ratios:h})=>{d==null||d(h[0])}});return g.addEventListener("resize",p),()=>{g.removeEventListener("resize",p)}},[s,n,d,t]),T`<slot hidden @slotchange=${v}></slot
		><slot name="previous" @slotchange=${v}></slot
		><cosmoz-resize-handle direction=${t}></cosmoz-resize-handle
		><slot name="next" @slotchange=${v}></slot>`};customElements.define("cosmoz-resizable-view",Se(zt,{styleSheets:[st],observedAttributes:["direction"]}));const{expect:x,waitFor:M}=__STORYBOOK_MODULE_TEST__,Mt={title:"Components/ResizableView",tags:["autodocs"]},A={render:()=>T`<cosmoz-resizable-view
