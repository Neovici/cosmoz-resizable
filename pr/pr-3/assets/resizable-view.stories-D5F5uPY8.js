var Xe=Object.defineProperty;var Ye=(t,e,s)=>e in t?Xe(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var c=(t,e,s)=>Ye(t,typeof e!="symbol"?e+"":e,s);import{f as Ke,B as Ze,E as te,x as A}from"./iframe-C2dg9tlD.js";import"./preload-helper-C1FmrZbK.js";let G,Ne=0;function ce(t){G=t}function le(){G=null,Ne=0}function Je(){return Ne++}const W=Symbol("haunted.phase"),I=Symbol("haunted.hook"),ue=Symbol("haunted.update"),de=Symbol("haunted.commit"),_=Symbol("haunted.effects"),k=Symbol("haunted.layoutEffects"),se="haunted.context";var ve,be,ye;ye=I,be=_,ve=k;class et{constructor(e,s){c(this,"update");c(this,"host");c(this,"virtual");c(this,ye);c(this,be);c(this,ve);this.update=e,this.host=s,this[I]=new Map,this[_]=[],this[k]=[]}run(e){ce(this);let s=e();return le(),s}_runEffects(e){let s=this[e];ce(this);for(let n of s)n.call(this);le()}runEffects(){this._runEffects(_)}runLayoutEffects(){this._runEffects(k)}teardown(){this[I].forEach(s=>{typeof s.teardown=="function"&&s.teardown(!0)})}}class tt extends Error{constructor(e){const s=e?` <${e}>`:"";super(`Infinite update loop detected in component${s}. This usually means a hook (useEffect, useMemo, useCallback) has dependencies that create new references on every render, such as [{}], [[]], or [Promise.resolve()]. Make sure your dependency arrays contain stable references.`),this.name="InfiniteLoopError"}}const st=100,nt=Promise.resolve().then.bind(Promise.resolve());function je(){let t=[],e;function s(){e=null;let n=t;t=[];for(var i=0,r=n.length;i<r;i++)n[i]()}return function(n){t.push(n),e==null&&(e=nt(s))}}const it=je(),he=je();var we;we=W;const Q=class Q{constructor(e,s){c(this,"renderer");c(this,"host");c(this,"state");c(this,we);c(this,"_updateQueued");c(this,"_active");c(this,"_updateCount");c(this,"_processing");this.renderer=e,this.host=s,this.state=new et(this.update.bind(this),s),this[W]=null,this._updateQueued=!1,this._active=!1,this._updateCount=0,this._processing=!1}_checkForInfiniteLoop(){if(this._processing||(this._updateCount=0),this._updateCount++,this._updateCount>Q.maxUpdates){const e=this.host instanceof HTMLElement?this.host.tagName.toLowerCase():void 0;throw this._active=!1,new tt(e)}}update(){this._active&&(this._updateQueued||(this._checkForInfiniteLoop(),this._processing=!0,it(()=>{let e=this.handlePhase(ue);he(()=>{this.handlePhase(de,e),he(()=>{this.handlePhase(_),this._updateQueued||(this._processing=!1)})}),this._updateQueued=!1}),this._updateQueued=!0))}handlePhase(e,s){switch(this[W]=e,e){case de:this.commit(s),this.runEffects(k);return;case ue:return this.render();case _:return this.runEffects(_)}}render(){return this.state.run(()=>this.renderer.call(this.host,this.host))}runEffects(e){this.state._runEffects(e)}teardown(){this.state.teardown(),this._updateCount=0,this._processing=!1}pause(){this._active=!1}resume(){this._active=!0,this._updateCount=0}};c(Q,"maxUpdates",st);let ne=Q;const rt=(...t)=>{const e=new CSSStyleSheet;return e.replaceSync(t.join("")),e},ot=t=>t==null?void 0:t.map(e=>typeof e=="string"?rt(e):e),at=(t,...e)=>t.flatMap((s,n)=>[s,e[n]||""]).join(""),Te=at,ct=(t="")=>t.replace(/-+([a-z])?/g,(e,s)=>s?s.toUpperCase():"");function lt(t){class e extends ne{constructor(r,l,a){super(r,a||l);c(this,"frag");c(this,"renderResult");this.frag=l}commit(r){this.renderResult=t(r,this.frag)}}function s(n,i,r){const l=(r||i||{}).baseElement||HTMLElement,{observedAttributes:a=[],useShadowDOM:o=!0,shadowRootInit:d={},styleSheets:m}=r||i||{},M=ot(n.styleSheets||m);class x extends l{constructor(){super();c(this,"_scheduler");if(o===!1)this._scheduler=new e(n,this);else{const u=this.attachShadow({mode:"open",...d});M&&(u.adoptedStyleSheets=M),this._scheduler=new e(n,u,this)}}static get observedAttributes(){return n.observedAttributes||a||[]}connectedCallback(){var u;this._scheduler.resume(),this._scheduler.update(),(u=this._scheduler.renderResult)==null||u.setConnected(!0)}disconnectedCallback(){var u;this._scheduler.pause(),this._scheduler.teardown(),(u=this._scheduler.renderResult)==null||u.setConnected(!1)}attributeChangedCallback(u,p,f){if(p===f)return;let v=f===""?!0:f;Reflect.set(this,ct(u),v)}}function B(b){let h=b,u=!1;return Object.freeze({enumerable:!0,configurable:!0,get(){return h},set(p){u&&h===p||(u=!0,h=p,this._scheduler&&this._scheduler.update())}})}const $=new Proxy(l.prototype,{getPrototypeOf(b){return b},set(b,h,u,p){let f;return h in b?(f=Object.getOwnPropertyDescriptor(b,h),f&&f.set?(f.set.call(p,u),!0):(Reflect.set(b,h,u,p),!0)):(typeof h=="symbol"||h[0]==="_"?f={enumerable:!0,configurable:!0,writable:!0,value:u}:f=B(u),Object.defineProperty(p,h,f),f.set&&f.set.call(p,u),!0)}});return Object.setPrototypeOf(x.prototype,$),x}return s}class E{constructor(e,s){c(this,"id");c(this,"state");this.id=e,this.state=s}}function ut(t,...e){let s=Je(),n=G[I],i=n.get(s);return i||(i=new t(s,G,...e),n.set(s,i)),i.update(...e)}function S(t){return ut.bind(null,t)}function De(t){return S(class extends E{constructor(s,n,i,r){super(s,n);c(this,"callback");c(this,"lastValues");c(this,"values");c(this,"_teardown");t(n,this)}update(s,n){this.callback=s,this.values=n}call(){const s=!this.values||this.hasChanged();this.lastValues=this.values,s&&this.run()}run(){this.teardown(),this._teardown=this.callback.call(this.state)}teardown(s){typeof this._teardown=="function"&&(this._teardown(),this._teardown=void 0),s&&(this.lastValues=this.values=void 0)}hasChanged(){return!this.lastValues||this.values.some((s,n)=>this.lastValues[n]!==s)}})}function qe(t,e){t[_].push(e)}const P=De(qe),dt=t=>t instanceof Element?t:t.startNode||t.endNode||t.parentNode,ht=S(class extends E{constructor(e,s,n){super(e,s);c(this,"Context");c(this,"value");c(this,"_ranEffect");c(this,"_unsubscribe");this._updater=this._updater.bind(this),this._ranEffect=!1,this._unsubscribe=null,qe(s,this)}update(e){return this.Context!==e&&(this._subscribe(e),this.Context=e),this.value}call(){this._ranEffect||(this._ranEffect=!0,this._unsubscribe&&this._unsubscribe(),this._subscribe(this.Context),this.state.update())}_updater(e){this.value=e,this.state.update()}_subscribe(e){const s={Context:e,callback:this._updater};dt(this.state.host).dispatchEvent(new CustomEvent(se,{detail:s,bubbles:!0,cancelable:!0,composed:!0}));const{unsubscribe:i=null,value:r}=s;this.value=i?r:e.defaultValue,this._unsubscribe=i}teardown(){this._unsubscribe&&this._unsubscribe()}});function ft(t){return e=>{const s={Provider:class extends HTMLElement{constructor(){super();c(this,"listeners");c(this,"_value");this.style.display="contents",this.listeners=new Set,this.addEventListener(se,this)}disconnectedCallback(){this.removeEventListener(se,this)}handleEvent(i){const{detail:r}=i;r.Context===s&&(r.value=this.value,r.unsubscribe=this.unsubscribe.bind(this,r.callback),this.listeners.add(r.callback),i.stopPropagation())}unsubscribe(i){this.listeners.delete(i)}set value(i){this._value=i;for(let r of this.listeners)r(i)}get value(){return this._value}},Consumer:t(function({render:n}){const i=ht(s);return n(i)},{useShadowDOM:!1}),defaultValue:e};return s}}const V=S(class extends E{constructor(e,s,n,i){super(e,s);c(this,"value");c(this,"values");this.value=n(),this.values=i}update(e,s){return this.hasChanged(s)&&(this.values=s,this.value=e()),this.value}hasChanged(e=[]){return e.some((s,n)=>this.values[n]!==s)}}),pt=(t,e)=>V(()=>t,e);function mt(t,e){t[k].push(e)}De(mt);const vt=S(class extends E{constructor(e,s,n){super(e,s);c(this,"args");this.updater=this.updater.bind(this),typeof n=="function"&&(n=n()),this.makeArgs(n)}update(){return this.args}updater(e){const[s]=this.args;typeof e=="function"&&(e=e(s)),!Object.is(s,e)&&(this.makeArgs(e),this.state.update())}makeArgs(e){this.args=Object.freeze([e,this.updater])}});S(class extends E{constructor(e,s,n,i,r){super(e,s);c(this,"reducer");c(this,"currentState");this.dispatch=this.dispatch.bind(this),this.currentState=r!==void 0?r(i):i}update(e){return this.reducer=e,[this.currentState,this.dispatch]}dispatch(e){this.currentState=this.reducer(this.currentState,e),this.state.update()}});const bt=/([A-Z])/gu;S(class extends E{constructor(e,s,n,i){super(e,s);c(this,"property");c(this,"eventName");if(this.state.virtual)throw new Error("Can't be used with virtual components.");this.updater=this.updater.bind(this),this.property=n,this.eventName=n.replace(bt,"-$1").toLowerCase()+"-changed",this.state.host[this.property]==null&&(typeof i=="function"&&(i=i()),i!=null&&this.updater(i,!0))}update(e,s){return[this.state.host[this.property],this.updater]}resolve(e){const s=this.state.host[this.property],n=typeof e=="function"?e:void 0,i=n?n(s):e;return[s,i,n]}notify(e,s){const n=new CustomEvent(this.eventName,{detail:{value:e,updater:s,path:this.property},cancelable:!0});return this.state.host.dispatchEvent(n),n}updater(e,s=!1){const[n,i,r]=this.resolve(e),l=this.notify(i,r);!s&&l.defaultPrevented||Object.is(n,i)||(this.state.host[this.property]=i)}});function yt(t){let e=t;return{get current(){return e},set current(s){e=s},get value(){return e},set value(s){e=s}}}function C(t){return V(()=>yt(t),[])}const Fe=S(class extends E{update(){return this.state.host}});function wt({render:t}){const e=lt(t),s=ft(e);return{component:e,createContext:s}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const xt={CHILD:2},gt=t=>(...e)=>({_$litDirective$:t,values:e});class zt{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,s,n){this._$Ct=e,this._$AM=s,this._$Ci=n}_$AS(e,s){return this.update(e,s)}update(e,s){return this.render(...s)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const L=(t,e)=>{var n;const s=t._$AN;if(s===void 0)return!1;for(const i of s)(n=i._$AO)==null||n.call(i,e,!1),L(i,e);return!0},U=t=>{let e,s;do{if((e=t._$AM)===void 0)break;s=e._$AN,s.delete(t),t=e}while((s==null?void 0:s.size)===0)},He=t=>{for(let e;e=t._$AM;t=e){let s=e._$AN;if(s===void 0)e._$AN=s=new Set;else if(s.has(t))break;s.add(t),St(e)}};function _t(t){this._$AN!==void 0?(U(this),this._$AM=t,He(this)):this._$AM=t}function Et(t,e=!1,s=0){const n=this._$AH,i=this._$AN;if(i!==void 0&&i.size!==0)if(e)if(Array.isArray(n))for(let r=s;r<n.length;r++)L(n[r],!1),U(n[r]);else n!=null&&(L(n,!1),U(n));else L(this,t)}const St=t=>{t.type==xt.CHILD&&(t._$AP??(t._$AP=Et),t._$AQ??(t._$AQ=_t))};class Mt extends zt{constructor(){super(...arguments),this._$AN=void 0}_$AT(e,s,n){super._$AT(e,s,n),He(this),this.isConnected=e._$AU}_$AO(e,s=!0){var n,i;e!==this.isConnected&&(this.isConnected=e,e?(n=this.reconnected)==null||n.call(this):(i=this.disconnected)==null||i.call(this)),s&&(L(this,e),U(this))}setValue(e){if(Ke(this._$Ct))this._$Ct._$AI(e,this);else{const s=[...this._$Ct._$AH];s[this._$Ci]=e,this._$Ct._$AI(s,this,0)}}disconnected(){}reconnected(){}}const{component:Oe}=wt({render:Ze}),X=new WeakMap,Y=gt(class extends Mt{render(t){return te}update(t,[e]){var n;const s=e!==this.G;return s&&this.G!==void 0&&this.rt(void 0),(s||this.lt!==this.ct)&&(this.G=e,this.ht=(n=t.options)==null?void 0:n.host,this.rt(this.ct=t.element)),te}rt(t){if(this.isConnected||(t=void 0),typeof this.G=="function"){const e=this.ht??globalThis;let s=X.get(e);s===void 0&&(s=new WeakMap,X.set(e,s)),s.get(this.G)!==void 0&&this.G.call(this.ht,void 0),s.set(this.G,t),t!==void 0&&this.G.call(this.ht,t)}else this.G.value=t}get lt(){var t,e;return typeof this.G=="function"?(t=X.get(this.ht??globalThis))==null?void 0:t.get(this.G):(e=this.G)==null?void 0:e.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}}),fe=t=>typeof t=="number"&&!Number.isNaN(t)&&t>=0&&t<=1?t:void 0,$t=(t="cosmoz-resizable-view:")=>{const e=new Map;let s;const n=new Map,i=()=>{s=void 0;for(const[a,o]of n)try{localStorage.setItem(t+a,String(o))}catch{}n.clear()},r=(a,o)=>{n.set(a,o),s===void 0&&(s=setTimeout(i,100))},l=a=>{if(a.key===null||!a.key.startsWith(t)||a.newValue===null)return;const o=a.key.slice(t.length),d=fe(Number(a.newValue));if(d===void 0)return;const m=e.get(o);if(m)for(const M of m)M(d)};return typeof window<"u"&&window.addEventListener("storage",l),{get(a){let o;try{o=localStorage.getItem(t+a)}catch{return}if(o!==null)return fe(Number(o))},set(a,o){r(a,o)},subscribe(a,o){let d=e.get(a);return d||(d=new Set,e.set(a,d)),d.add(o),()=>{const m=e.get(a);m&&(m.delete(o),m.size===0&&e.delete(a))}},destroy(){typeof window<"u"&&window.removeEventListener("storage",l),s!==void 0&&(clearTimeout(s),i())}}},At=(t,e,s)=>{const n=C(s);if(n.current=s,P(()=>{var l,a;if(!t||!e)return;const i=t.get(e);i!==void 0&&((l=n.current)==null||l.call(n,i));const r=(a=t.subscribe)==null?void 0:a.call(t,e,o=>{var d;return(d=n.current)==null?void 0:d.call(n,o)});return()=>{var o;r==null||r(),(o=t.destroy)==null||o.call(t)}},[t,e]),!(!t||!e))return i=>t.set(e,i)},Ct=Te`
	:host {
		display: flex;
		flex-direction: row;
		width: 100%;
...
`,Gt=({direction:t="horizontal"})=>(Ot(t),te);customElements.define("cosmoz-resize-handle",Oe(Gt,{styleSheets:[It],observedAttributes:["direction"]}));const Vt=(t,e,s)=>s==="horizontal"?t.x-e.left:t.y-e.top,Ue=(t,e)=>e==="horizontal"?t.width:t.height,Ut=(t,e,s)=>{let n=t;return e!==void 0&&(n=Math.max(n,e)),s!==void 0&&(n=Math.min(n,s)),Math.max(0,n)},Qt=(t,e)=>{const s=e>0?e:1,n=t/s;return[n,1-n]},Wt=(t,e,s)=>(t.rect||(t.rect=e.container.getBoundingClientRect(),t.size=Ue(t.rect,s)),t.rect),Xt=t=>{const e={rect:void 0,size:0},s=(n,i,r)=>{var d,m;const l=Wt(e,r.elements,r.direction),a=Ut(Vt(i,l,r.direction),r.minSize,r.maxSize),o=Qt(a,e.size);n==="move"?(d=r.onResize)==null||d.call(r,{ratios:o,px:a}):((m=r.onResizeEnd)==null||m.call(r,{ratios:o}),e.rect=void 0)};return n=>{var l;const{phase:i,mousePosition:r}=n.detail;if(i==="start"){e.rect=t.elements.container.getBoundingClientRect(),e.size=Ue(e.rect,t.direction),(l=t.onResizeStart)==null||l.call(t);return}(i==="move"||i==="end")&&s(i,r,t)}},J=(t,e)=>t.dispatchEvent(new CustomEvent("resize-panels",{detail:{ratios:e},bubbles:!0})),ee=(t,e)=>{const s=t.getBoundingClientRect();return e==="horizontal"?s.width:s.height},Yt=({direction:t="horizontal",initialSizes:e=[.5,.5],minSize:s,maxSize:n,persist:i})=>{const r=Fe(),l=C(.5),a=C(),o=C(),d=C(),[m,M]=vt(!1),x=V(()=>{if(typeof i=="string")return $t();if(i&&typeof i=="object")return i},[i]),B=V(()=>{if(typeof i=="string")return i;if(i&&typeof i=="object")return"default"},[i]),$=At(x,B,h=>{var w,g;l.current=h;const u=(w=o.current)==null?void 0:w.assignedElements()[0],p=(g=d.current)==null?void 0:g.assignedElements()[0];if(!u||!p)return;const f=ee(r,t),{ratios:v}=Z(u,p,h*f,f);J(r,v)}),b=pt(()=>{const h=r.shadowRoot;if(!h)return;const u=o.current,p=d.current,f=h.querySelector("slot:not([name])");if(!u||!p||!f)return;let v=u.assignedElements()[0],w=p.assignedElements()[0];const g=f.assignedElements().filter(j=>!j.hasAttribute("slot"));!v&&g.length>0&&(v=g.shift(),v.setAttribute("slot","previous")),!w&&g.length>0&&(w=g.shift(),w.setAttribute("slot","next"));const N=a.current;v&&w&&N&&M(!0)},[]);return P(()=>{var h;r.setAttribute("data-direction",t),(h=a.current)==null||h.setAttribute("data-direction",t)},[t]),P(()=>{var re,oe,ae;if(!m)return;const h=a.current,u=(re=o.current)==null?void 0:re.assignedElements()[0],p=(oe=d.current)==null?void 0:oe.assignedElements()[0];if(!u||!p||!h)return;const f=ee(r,t),v=Tt(s,n,f),w=(ae=x==null?void 0:x.get)==null?void 0:ae.call(x,B??""),g=w!==void 0?Ht(w*f,v):Ft(e,v,f),{ratios:N}=Z(u,p,g,f);l.current=N[0],J(r,N);const j=Xt({elements:{previous:u,next:p,container:r},direction:t,minSize:v.prevMin,maxSize:v.prevMax,onResize:({ratios:T,px:Qe})=>{const We=ee(r,t);Z(u,p,Qe,We),l.current=T[0],J(r,T)},onResizeEnd:({ratios:T})=>{$==null||$(T[0])}});return h.addEventListener("resize-handle",j),()=>{h.removeEventListener("resize-handle",j)}},[s,n,$,t,m]),A`<slot hidden @slotchange=${b}></slot
		...
		><cosmoz-resize-handle
			...
			${Y(a)}
		></cosmoz-resize-handle
		><slot name="next" ${Y(d)} @slotchange=${b}></slot>`};customElements.define("cosmoz-resizable-view",Oe(Yt,{styleSheets:[Ct],observedAttributes:["direction"]}));const{expect:y,waitFor:z}=__STORYBOOK_MODULE_TEST__,es={title:"Components/ResizableView",tags:["autodocs"]},D={render:()=>A`<cosmoz-resizable-view
        ...
        </cosmoz-resizable-view>`,async play({canvasElement:t,step:e}){await e("Left panel capped at 360px (40% would be 400px)",async()=>{await z(()=>{const s=t.querySelector("#list");y(parseFloat(s.style.flexBasis)).toBeCloseTo(36,0)})})}};var xe,ge,ze;D.parameters={...D.parameters,docs:{...(xe=D.parameters)==null?void 0:xe.docs,source:{originalSource:`{
...
}`,...(ze=(ge=D.parameters)==null?void 0:ge.docs)==null?void 0:ze.source}}};var _e,Ee,Se;q.parameters={...q.parameters,docs:{...(_e=q.parameters)==null?void 0:_e.docs,source:{originalSource:`{
  render: () => html\`<cosmoz-resizable-view
            style="display:flex; flex-direction:column; width:600px; height:400px; border:1px solid #ccc;"
            direction="vertical"
            .initialSizes=\${[0.5, 0.5]}
...
}`,...(Se=(Ee=q.parameters)==null?void 0:Ee.docs)==null?void 0:Se.source}}};var Me,$e,Ae;F.parameters={...F.parameters,docs:{...(Me=F.parameters)==null?void 0:Me.docs,source:{originalSource:`{
  render: () => html\`<cosmoz-resizable-view
            style="display:flex; width:600px; height:300px; border:1px solid #ccc;"
            .initialSizes=\${[0.5, 0.5]}
        >
...
}`,...(Ae=($e=F.parameters)==null?void 0:$e.docs)==null?void 0:Ae.source}}};var Ce,ke,Le;H.parameters={...H.parameters,docs:{...(Ce=H.parameters)==null?void 0:Ce.docs,source:{originalSource:`{
  render: () => html\`<cosmoz-resizable-view
            style="display:flex; width:800px; height:300px; border:1px solid #ccc;"
...
}`,...(Le=(ke=H.parameters)==null?void 0:ke.docs)==null?void 0:Le.source}}};var Pe,Re,Be;O.parameters={...O.parameters,docs:{...(Pe=O.parameters)==null?void 0:Pe.docs,source:{originalSource:`{
  render: () => html\`<cosmoz-resizable-view
            style="display:flex; width:1000px; height:300px; border:1px solid #ccc;"
...
}`,...(Be=(Re=O.parameters)==null?void 0:Re.docs)==null?void 0:Be.source}}};const ts=["BasicDemo","VerticalDemo","MultiplePanels","ListDetailsSplit","CappedInitialSize"];export{D as BasicDemo,O as CappedInitialSize,H as ListDetailsSplit,F as MultiplePanels,q as VerticalDemo,ts as __namedExportsOrder,es as default};
