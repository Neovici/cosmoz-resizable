...
`,K=t=>t instanceof MouseEvent?{x:t.clientX,y:t.clientY}:t.touches&&t.touches.length>0?{x:t.touches[0].clientX,y:t.touches[0].clientY}:{x:0,y:0},Rt=(t,e,s)=>s==="horizontal"?t.x-e.left:t.y-e.top,pe=t=>{const e=parseFloat(t);return Number.isNaN(e)?void 0:e},Nt=(t,e)=>{const s=getComputedStyle(t);return{min:e==="horizontal"?pe(s.minWidth)??0:pe(s.minHeight)??0}},fe=t=>({rect:t.container.getBoundingClientRect(),bounds:Nt(t.previous,t.direction)}),kt=(t,e,s,n)=>Math.max(n.min,Rt(t,e,s)),qt=t=>{let e;return s=>{var c,r;const{phase:n,mousePosition:o}=s.detail;if(n==="start"){e=fe(t);return}if(n!=="move"&&n!=="end")return;e||(e=fe(t));const i=kt(o,e.rect,t.direction,e.bounds);n==="move"?(c=t.onResize)==null||c.call(t,i):((r=t.onResizeEnd)==null||r.call(t),e=void 0)}},Tt=(t="horizontal")=>{const e=We();return M(()=>{e.setAttribute("data-direction",t)},[t]),M(()=>{const s=(d,_)=>{e.dispatchEvent(new CustomEvent("resize-handle",{detail:{phase:d,mousePosition:_},bubbles:!0}))};let n=0,o;const i=()=>{n=0,o&&(s("move",o),o=void 0)},c=d=>{o=K(d),n||(n=requestAnimationFrame(i))},r=d=>{n&&(cancelAnimationFrame(n),i()),e.removeAttribute("data-dragging"),s("end",K(d)),document.removeEventListener("mousemove",c),document.removeEventListener("mouseup",r),document.removeEventListener("touchmove",c),document.removeEventListener("touchend",r)},a=d=>{e.setAttribute("data-dragging","true"),s("start",K(d)),document.addEventListener("mousemove",c),document.addEventListener("mouseup",r),document.addEventListener("touchmove",c,{passive:!1}),document.addEventListener("touchend",r)},u=d=>{d.preventDefault(),a(d)},h=d=>{d.preventDefault(),a(d)};return e.addEventListener("mousedown",u),e.addEventListener("touchstart",h,{passive:!1}),()=>{n&&cancelAnimationFrame(n),e.removeEventListener("mousedown",u),e.removeEventListener("touchstart",h),document.removeEventListener("mousemove",c),document.removeEventListener("mouseup",r),document.removeEventListener("touchmove",c),document.removeEventListener("touchend",r)}},[e]),null},Dt=Ge`
	:host {
		display: flex;
		position: relative;
		z-index: 1;
...
`,Ft=({direction:t="horizontal"})=>(Tt(t),ee);customElements.define("cosmoz-resize-handle",Ve(Ft,{styleSheets:[Dt],observedAttributes:["direction"]}));const ve=t=>getComputedStyle(t).display!=="none",Z=t=>t==null?void 0:t.assignedElements()[0],Ht=(t,e,s)=>{const n=()=>{const i=ve(e)&&ve(s);t.toggleAttribute("data-single-panel",!i)},o=new ResizeObserver(()=>queueMicrotask(n));return o.observe(e),o.observe(s),n(),o},me=(t,e)=>{if(e==null){t.style.flexBasis="";return}t.style.flexBasis=`${e.px}px`},be=(t,e,s,n,o)=>{const i=(c,r)=>{const{previous:a,next:u}=Bt(r??null),h=`--resizable-previous-${e}${c}`,d=`--resizable-next-${e}${c}`;a!=null?t.style.setProperty(h,a):t.style.removeProperty(h),u!=null?t.style.setProperty(d,u):t.style.removeProperty(d)};i("",s),i("-horizontal",n),i("-vertical",o)},Ot=({direction:t="horizontal",persist:e,initialSize:s,initialSizeHorizontal:n,initialSizeVertical:o,minSize:i,minSizeHorizontal:c,minSizeVertical:r})=>{const a=We(),u=B(),h=B(),d=B(),_=B(),[A,V]=bt({prev:void 0,next:void 0}),w=e?`${e}:${t}`:void 0,f=ne(()=>e?Lt():void 0,[e]),p=Pt(f,w,m=>{const g=Z(h.current);g&&me(g,m)}),b=B(p);b.current=p;const v=de(()=>{var L,k;const m=(L=h.current)==null?void 0:L.assignedElements()[0],g=(k=d.current)==null?void 0:k.assignedElements()[0];V(P=>P.prev===m&&P.next===g?P:{prev:m,next:g})},[]),X=de(()=>{var m;(m=_.current)==null||m.assignedElements().forEach(g=>g.setAttribute("slot","previous"))},[]);return M(()=>{a.setAttribute("data-direction",t)},[t]),M(()=>{be(a,"basis",s,n,o),be(a,"min",i,c,r)},[a,s,n,o,i,c,r]),M(()=>{if(!A.prev||!A.next)return;const m=Z(h.current),g=Z(d.current),L=u.current;if(!m||!g||!L)return;m.style.flexBasis="",g.style.flexBasis="";const k=w?f==null?void 0:f.get(w):void 0;me(m,k);const P=qt({container:a,previous:m,direction:t,onResize:q=>{m.style.flexBasis=`${q}px`},onResizeEnd:()=>{requestAnimationFrame(()=>{var oe;const q=m.getBoundingClientRect(),Ye=t==="horizontal"?q.width:q.height;(oe=b.current)==null||oe.call(b,{px:Ye})})}});L.addEventListener("resize-handle",P);const Xe=Ht(a,m,g);return()=>{L.removeEventListener("resize-handle",P),Xe.disconnect()}},[t,f,e,a,A.prev,A.next]),E`<slot
			${T(_)}
			@slotchange=${X}
		></slot
		><slot
        ...
        </cosmoz-resizable-view>`,async play({canvasElement:t,step:e}){await e("Renders with vertical direction",async()=>{const s=t.querySelector("cosmoz-resizable-view");await z(()=>{y(s.getAttribute("data-direction")).toBe("vertical")}),await z(()=>{var o;const n=(o=s.shadowRoot)==null?void 0:o.querySelector("cosmoz-resize-handle");y(n==null?void 0:n.getAttribute("data-direction")).toBe("vertical")})})}},H={render:()=>E`<cosmoz-resizable-view
            style="display:flex; width:600px; height:300px; border:1px solid #ccc;"
        >
        ...
        </cosmoz-resizable-view>`,async play({canvasElement:t,step:e}){await e("Renders nested resizable views",async()=>{await z(()=>{var o,i;const s=(o=t.shadowRoot)==null?void 0:o.querySelector("cosmoz-resize-handle");y(s).not.toBeNull();const n=t.querySelector("cosmoz-resizable-view cosmoz-resizable-view");y(n).not.toBeNull(),y((i=n==null?void 0:n.shadowRoot)==null?void 0:i.querySelector("cosmoz-resize-handle")).not.toBeNull()})})}},O={render:()=>E`<cosmoz-resizable-view
        ...
        </cosmoz-resizable-view>`,async play({canvasElement:t,step:e}){const s=t.querySelector("#resizable"),n=()=>s.getBoundingClientRect().left,o=t.querySelector("#a"),i=t.querySelector("#b"),c=a=>Math.round(a.getBoundingClientRect().width),r=()=>{for(const a of[o,i])a.setAttribute("slot",a.getAttribute("slot")==="previous"?"next":"previous")};await e("Drag sets the previous panel width",async()=>{ye(s,n()+400),await z(()=>{y(c(o)).toBe(400)})}),await e("Swap slots: panel B becomes previous",async()=>{r(),await z(()=>{var u,h,d;const a=(d=(h=(u=s.shadowRoot)==null?void 0:u.querySelector('slot[name="previous"]'))==null?void 0:h.assignedElements()[0])==null?void 0:d.id;y(a).toBe("b")})}),await e("Drag after reassignment tracks the cursor (stale bases cleared)",async()=>{ye(s,n()+300),await z(()=>{y(c(i)).toBe(300)}),y(o.style.flexBasis).toBe("")})}};var _e,Se,Ee;D.parameters={...D.parameters,docs:{...(_e=D.parameters)==null?void 0:_e.docs,source:{originalSource:`{
...
}`,...(Ae=(Ce=F.parameters)==null?void 0:Ce.docs)==null?void 0:Ae.source}}};var Le,Pe,Be;H.parameters={...H.parameters,docs:{...(Le=H.parameters)==null?void 0:Le.docs,source:{originalSource:`{
  render: () => html\`<cosmoz-resizable-view
            style="display:flex; width:600px; height:300px; border:1px solid #ccc;"
        >
...
}`,...(Be=(Pe=H.parameters)==null?void 0:Pe.docs)==null?void 0:Be.source}}};var Me,Re,Ne;O.parameters={...O.parameters,docs:{...(Me=O.parameters)==null?void 0:Me.docs,source:{originalSource:`{
  render: () => html\`<cosmoz-resizable-view
            style="display:flex; width:800px; height:300px; border:1px solid #ccc;"
        >
            <div
...
}`,...(Ne=(Re=O.parameters)==null?void 0:Re.docs)==null?void 0:Ne.source}}};var ke,qe,Te;I.parameters={...I.parameters,docs:{...(ke=I.parameters)==null?void 0:ke.docs,source:{originalSource:`{
  render: () => html\`<cosmoz-resizable-view
            style="display:flex; width:1000px; height:300px; border:1px solid #ccc;"
        >
            <div
...
}`,...(Te=(qe=I.parameters)==null?void 0:qe.docs)==null?void 0:Te.source}}};var De,Fe,He;G.parameters={...G.parameters,docs:{...(De=G.parameters)==null?void 0:De.docs,source:{originalSource:`{
  render: () => html\`<cosmoz-resizable-view
            id="resizable"
            style="display:flex; width:800px; height:300px; border:1px solid #ccc;"
        >
